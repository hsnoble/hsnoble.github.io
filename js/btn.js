                    ...
                    "<div class='row'>" +
                        "<div class='col-lg-8 col-lg-offset-2'>" +
                            "<div class='modal-body'>" +
								...
								"				<li><a href='https://github.com/hsnoble'><i class='fab fa-github fa-2x' style='margin-top: 10px;'></i></a></li> " +
								"		</ul> " +
								"	</div> " +
								"</div>" +
